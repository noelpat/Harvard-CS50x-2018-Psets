/* CS50 - Problem Set 4 - whodunit

This program reveals Mr. Boddy's drawing in such
a way that you can recognize whodunit.
*/
...
int main(int argc, string argv[])
{
    ...
    //code from copy.c supplied in cs50 zip file ****
    // remember filenames
    char *infile = argv[1];
    char *outfile = argv[2];
    ...
    for (int i = 0, biHeight = abs(bi.biHeight); i < biHeight; i++)
    {
        ...
        for (int j = 0; j < bi.biWidth; j++)
        {
            ...
            //if statement to check for certain color (red)
